...
const reducer = (state: BookContextProps, action: BookContextAction): BookContextProps => {
  switch (action.type) {
    case 'UPDATE_DATA': 
      return {
...
const BookContext = createContext<{ state: BookContextProps; dispatch: Dispatch<BookContextAction> } | undefined>(
  undefined
);
