...
import { ApiParams, Book, BookResponse, BooksVolumesResponse, Item } from '../types/sherTypes';
 ...
 const baseUrl = import.meta.env.VITE_API_URL
  ...
  export const fetchBooks = async ({ q, startIndex, maxResults }: ApiParams): Promise<AxiosResponse<BookResponse>> => {
